...
namespace WindowsFormsApp1
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            {
                //Запрос названия товаров с соответствующими продавцами
                String quertString2 = @"select nazvanie from aukcuonnye_veshi where aukcuonnye_veshi.kod_prodavca='" + id[i] + "';";
                con.Open();
