...
namespace WindowsFormsApp1
{
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            quertString = @"select * from Kategorii;";
            con.Open();
            ...
            {
                //Запрос названия книг с соответствующими Id категорий
                String quertString2 = @"select nazvanie_knigi from Knigi where Knigi.Id_kategorii='" + id[i] + "';";
                con.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)//Если пользователь сохранил документ
            {
                ...
                worksheet.Name = "Книги по категориям"; // Изменение имени рабочего листа
                // Заполнение Excel документа
                worksheet.Cells[1, 1] = "Книги по категориям:";
